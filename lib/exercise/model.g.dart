...
const ExerciseSchema = CollectionSchema(
  ...
  links: {
    r'category': LinkSchema(
      id: -5221613386619114039,
      name: r'category',
      target: r'ExerciseCategory',
      single: true,
    ),
...
List<IsarLinkBase<dynamic>> _exerciseGetLinks(Exercise object) {
  return [object.category, object.muscleGroup, object.difficultyLevel];
}
...
void _exerciseAttach(IsarCollection<dynamic> col, Id id, Exercise object) {
  ...
  object.category.attach(
    col,
    col.isar.collection<ExerciseCategory>(),
    r'category',
    id,
  );
  object.muscleGroup.attach(
    col,
    col.isar.collection<MuscleGroup>(),
    r'muscleGroup',
    id,
  );
...
extension ExerciseQueryLinks
    on QueryBuilder<Exercise, Exercise, QFilterCondition> {
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> category(
    FilterQuery<ExerciseCategory> q,
  ) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> categoryIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'category', 0, true, 0, true);
    });
  }

  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> muscleGroup(
    FilterQuery<MuscleGroup> q,
  ) {
    return QueryBuilder.apply(this, (query) {
      return query.link(q, r'muscleGroup');
    });
  }

  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> muscleGroupIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.linkLength(r'muscleGroup', 0, true, 0, true);
    });
  }

  QueryBuilder<Exercise, Exercise, QAfterFilterCondition> difficultyLevel(
