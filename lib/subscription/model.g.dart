...
void _subscriptionSerialize(
  ...
  writer.writeLong(offsets[0], object.monthlyCost);
...
Subscription _subscriptionDeserialize(
  ...
  final object = Subscription(
    id: id,
    monthlyCost: reader.readLong(offsets[0]),
...
extension SubscriptionQueryFilter
  ...
  monthlyCostEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.equalTo(property: r'monthlyCost', value: value),
      );
    });
  }

  QueryBuilder<Subscription, Subscription, QAfterFilterCondition>
  monthlyCostGreaterThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.greaterThan(
          include: include,
  ...
  QueryBuilder<Subscription, Subscription, QAfterFilterCondition>
  monthlyCostLessThan(int value, {bool include = false}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(
        FilterCondition.lessThan(
          include: include,
...
extension SubscriptionQuerySortBy
  ...
  QueryBuilder<Subscription, Subscription, QAfterSortBy> sortByMonthlyCost() {
    return QueryBuilder.apply(this, (query) {
...
extension SubscriptionQuerySortThenBy
  ...
  QueryBuilder<Subscription, Subscription, QAfterSortBy> thenByMonthlyCost() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'monthlyCost', Sort.asc);
    });
  }
...
extension SubscriptionQueryWhereDistinct
  ...
  QueryBuilder<Subscription, Subscription, QDistinct> distinctByMonthlyCost() {
    return QueryBuilder.apply(this, (query) {
...
extension SubscriptionQueryProperty
  ...
  QueryBuilder<Subscription, int, QQueryOperations> monthlyCostProperty() {
    return QueryBuilder.apply(this, (query) {
