...
MuscleGroup _muscleGroupDeserialize(
  ...
  final object = MuscleGroup(id: id, name: reader.readString(offsets[0]));
  return object;
}
...
extension MuscleGroupQueryWhere
  ...
  QueryBuilder<MuscleGroup, MuscleGroup, QAfterWhereClause> idGreaterThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<MuscleGroup, MuscleGroup, QAfterWhereClause> idLessThan(
    Id id, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
